...
*/
    ...
    * {
    ...
    <blade media|%20(max-width%3A%201000px)%20%7B%0D>td:not(:first-of-type) {
        min-width: 12.1rem;
    }
    }
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> NIK <span class="icon-arrow">&UpArrow;</span></th>
                        ...
                        <th> CAKAR <span class="icon-arrow">&UpArrow;</span></th>
                        <th> 12 MONTHS RETIREMENT <span class="icon-arrow">&UpArrow;</span></th>
                        <th> 6 MONTHS RETIREMENT <span class="icon-arrow">&UpArrow;</span></th>
                        <th> MAX RETIREMENT 56 YEARS <span class="icon-arrow">&UpArrow;</span></th>
                    </tr>
                </thead>
                @php
                    $no = 1;
