...
<body width="100%"
    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <div style="width: 985px; margin: 0 auto;" class="email-container">
            <!-- BEGIN BODY -->
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="logo" style="text-align: center;">
                                    <h1><a href="#">NOTIFIKASI PENSIUN KARYAWAN</a></h1>
                                    <h4><a href="#">BERIKUT KARYAWAN YANG TELAH SELESAI MASA KERJANYA</a>
                                    </h4>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <h3>Speed & Quality</h3>
                                        <div class="d">
                                            <p style="color: rgba(0,0,0,.8);">THANK YOU FOR SERVING THE LIVES OF PEOPLE
                                        ...
                                        <h3>DATA PENSIUN KARYAWAN DAK</h3>
                                                        ...
                                                        <td class="ps-4">
                                                            <p class="text-xs font-weight-bold mb-0">
                                                                @if ($k->pilihan_pensiun == 6)
                                                                    {{ date('Y-m-d', strtotime($k->tgl_lahir . ' +55years')) }}
                                                                @else
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            <td style="text-align: left; padding-left: 10px;">
                                                <h3 class="heading">Best Regards,</h3>

                                                <br>

                                                <h4 class="heading">SDM PT DAK</h4>
                                                {{-- <ul>
                                                    <li><a href="#">Home</a></li>
