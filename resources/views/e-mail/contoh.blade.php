...
<main>
    <td valign="top" class="bg_white" style="margin: auto;">
        <div style="display: flex; justify-items:center;">
            <img src="{{ asset('admin/assets/img/timah.png') }}" alt=""
                style="margin-right:auto;max-height: 100px">
            <img src="{{ asset('admin/assets/img/ptdaklogo.png') }}" alt="" style="max-height: 100px">
        </div>
        {{-- <img class="kiri" src="{{ asset('admin/assets/img/baru2.png') }}" hidden ari\a-colspan="" /> --}}
