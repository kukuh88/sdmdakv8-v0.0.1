                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">WEBSITE SDM NOTIFIKASI</span>
                                </a>
                            </div><!-- End Logo -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="row g-3 needs-validation"
                                        ...
                                        <div class="col-12">
                                            ...
                                            {{-- <p class="small mb-0">Don't have account? <a href="/help">Create an
                                                    account</a></p> --}}
                                        </div>
                                    </form>
                            ...
                            <div class="credits">
                                ...
                                Designed by <a href="https://www.instagram.com/k.kukuh/?r=nametag%2F">PT DAK SDM &
                                    IT</a>
                            </div>
